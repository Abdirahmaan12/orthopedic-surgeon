...
?>
  ...
  <div class="row justify-content-center mt-4">
    <div class="col-sm-8">
      <div class="card">
        <div class="text-end">
        <button type="button" class="btn btn-outline-primary  m-2" data-bs-toggle="modal" data-bs-target="#bilsmodal">
       Add Bills
         </button>
         </div>
        <table class="table  table-hover table-bordered border-primary" id="billsTable">
...
<div class="col-sm-5">
   ...
   <select name="em_name" id="em_name" class="form-control">
