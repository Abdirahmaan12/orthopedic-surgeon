...
?>
  ...
  <div class="row justify-content-center mt-4">
    <div class="col-sm-8">
      <div class="card">
        <div class="text-end">
        <button type="button" class="btn btn-outline-primary  m-2" data-bs-toggle="modal" data-bs-target="#resultmodal">
       Add result
         </button>
         </div>
        <table class="table  table-hover table-bordered border-primary" id="resultTable">
      ...
      <form id="resultform">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <select name="p_namee" id="p_namee" class="form-control">
