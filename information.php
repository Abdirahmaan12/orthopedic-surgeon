...
?>
  ...
  <div class="row justify-content-center mt-4">
    <div class="col-sm-10">
      <div class="card">
        <div class="text-end">
        <button type="button" class="btn btn-outline-primary  m-2" data-bs-toggle="modal" data-bs-target="#info_modal">
       Add info
         </button>
         </div>
        <table class="table  table-hover table-bordered border-primary" id="infoTable">
      ...
      <form id="infoform">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <select name="peetient_name" id="peetient_name" class="form-control">
